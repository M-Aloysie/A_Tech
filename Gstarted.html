    ...
    <nav class="navbar navbar-expand-lg  " style="background-color: transparent;"  id="navbar">
      ...
      <section id="hero" class="d-flex align-items-center" style="background-color: transparent;">
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
          ...
          <br>
          <br>
          <h2 style="color: rgb(10, 84, 20); font-weight: bolder;font-size: 40px; text-align: center; opacity: 0.9; margin-top: 60px;"><b>About Us</b></h2>
          <br>
          <br>
      ...
      <br>
        ...
        <div class="d-grid gap-2 col-6 mx-auto" style="margin-top: -500px; opacity: 0.8;">
          ...
          <br>
          <br>
          <h2 style="color: rgb(10, 84, 20); font-weight: bolder;font-size: 40px; text-align: center; opacity: 0.9; "><b>Our Services</b></h2>
          <br>
          ...
          <br>
          <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style="margin-bottom: 400px;">
          ...
          <br>
          <h2 style="color:rgb(91, 54, 10); font-weight: bolder;font-size: 40px; text-align: center; opacity: 0.9; margin-top: -400px; margin-bottom: 460px; "><b>Explore our services</b></h2>
          <br>
          <div class="row row-cols-1 row-cols-md-2 g-4" style="margin: 100px; margin-top: -450px;">
            <div class="col">
              <div class="card" id="card">
                <img src="/Images/service1.webp" class="card-img-top" alt="...">
            ...
            <div class="col">
              <div class="card" id="card">
                <img src="/Images/service2.jpg" style="height: 400px;" class="card-img-top" alt="..." id="service">
                <div class="card-body" style="background-color: rgb(55, 34, 8); color: rgb(148, 89, 17);">
            ...
            <div class="col">
              <div class="card" id="card">
                <img src="/Images/Service4.jpeg" style="height: 340px;" class="card-img-top" alt="...">
                <div class="card-body" style="background-color: rgb(55, 34, 8); color: rgb(148, 89, 17);">
