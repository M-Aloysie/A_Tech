...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: transparent; background-image: url('Wallpaper.jpg');">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <h1 style="font-size: 50px; font-family: Arial, Helvetica, sans-serif; font-weight: bolder;">
                <b><span style="color:rgb(12, 44, 12);">Agri</span><span style="color:rgb(139, 83, 13)">Tech</span></b>
            </h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <div class="profile-container ml-3">
                <div class="profile-links">
                    ...
                    <a href="signup.php" id="registerLink" style="color: rgb(218, 120, 9); opacity: 0.9;"
                       class="no-alert">Register</a>
                    <a href="#" id="loginLink" style="color: rgb(218, 120, 9); opacity: 0.9;" class="no-alert">Login</a>
                    <a href="#" id="logout" onclick="logout()" style="color: rgb(218, 120, 9); opacity: 0.9;"
                       class="no-alert">Logout</a>
                    <a href="edit.php" id="editProfileLink" style="color: rgb(218, 120, 9); opacity: 0.9;"
                       class="no-alert">Edit Profile</a>
                </div>
                <img id="profile-picture" src="Founder.jpg" alt="" style="opacity: 0.9;">
            </div>
        </div>
    </div>
</nav>   <div class="login-container" id="loginContainer">
        <h2>Login</h2>
